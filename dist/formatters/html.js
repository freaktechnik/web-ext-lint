...
const pageTemplate = lodash.template(fs.readFileSync(__nccwpck_require__.ab + "html-template-page.html", "utf-8"));
const messageTemplate = lodash.template(fs.readFileSync(__nccwpck_require__.ab + "html-template-message.html", "utf-8"));
const resultTemplate = lodash.template(fs.readFileSync(__nccwpck_require__.ab + "html-template-result.html", "utf-8"));
