module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "A CSS syntax error was encountered":[ "CSS సింటాక్స్ లోపం ఏర్పడింది" ],
      ...
      "A custom content_security_policy needs additional review.":[ "ఒక అభిమత content_security_policyకు అదనపు సమీక్ష అవసరం." ],
      "The \"name\" property must be a string.":[ "\"name\" లక్షణం స్ట్రింగ్ అయి ఉండాలి." ],
      ...
      "The \"version\" property must be a string.":[ "\"version\" లక్షణం స్ట్రింగ్ అయి ఉండాలి." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "మరింత సమాచారం కోసం http://mzl.la/1kXIADa (MDN డాక్స్) చూడండి." ],
      "The \"version\" property uses a Firefox-specific format.":[ "\"version\" లక్షణం Firefoxకి ప్రత్యేకమైన ఫార్మాటును వాడుతుంది." ] } } }