module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Ред" ],
      Column:[ "Колона" ],
      "Invalid nesting of selectors found":[ "Намерено е невалидно влагане на селектори" ],
      "A CSS syntax error was encountered":[ "Възникна грешка в синтаксиса на CSS" ],
      ...
      "The \"version\" property uses a Firefox-specific format.":[ "Свойството „version“ използва специфичен за Firefox формат." ] } } }