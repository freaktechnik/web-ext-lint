module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Linje" ],
      Column:[ "Kolonne" ],
      "Invalid nesting of selectors found":[ "Ugyldig nesting av selektorar funne" ],
      "A CSS syntax error was encountered":[ "Det oppstod ein CSS-syntaksfeil" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener' kalla med truthy som fjerde argument." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Ein tilpassa content_security_policy treng ytterlegare gransking." ],
      "The \"name\" property must be a string.":[ "Eigenskapen «namn» må vere ein streng." ],
      ...
      "The \"version\" property must be a string.":[ "Eigenskapen «versjon» må vere ein streng." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Sjå http://mzl.la/1kXIADa (MDN Docs) for meir informasjon." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Eigenskapen «versjon» nyttar eit Firefox-spesifikt format." ] } } }