module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Linje" ],
      Column:[ "Kolonne" ],
      "Invalid nesting of selectors found":[ "Ugyldig nesting av velgere funnet" ],
      "A CSS syntax error was encountered":[ "Det oppstod en CSS-syntaksfeil" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener ble kalt med truthy som fjerde argument." ],
