module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Linea" ],
      Column:[ "Columna" ],
      "Invalid nesting of selectors found":[ "Annidamento non valide de selectores trovate" ],
      "A CSS syntax error was encountered":[ "Un error de syntaxe de CSS occurreva" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener` appellate con un quarte argumento ‘truthy’ (considerate como ver)." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Un content_security_policy personalisate require un altere revision." ],
      "The \"name\" property must be a string.":[ "Le proprietate del \"nomine\" debe ser un catena." ],
      ...
      "The \"version\" property must be a string.":[ "Le proprietate del \"version\" debe ser un catena." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Vider http://mzl.la/1kXIADa (MDN Docs) pro altere informationes." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Le proprietate \"version\" usa un formato Firefox-specific." ] } } }