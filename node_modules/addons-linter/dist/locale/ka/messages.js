module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "სტრიქონი" ],
      Column:[ "სვეტი" ],
      "Invalid nesting of selectors found":[ "აღმოჩენილია არასწორად მოთავსებული სელექტორი" ],
      "A CSS syntax error was encountered":[ "შემჩნეულია CSS სინტაქსური შეცდომა" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener ` გამოძახებულია ჭეშმარიტი მეოთხე არგუმენტით." ],
      ...
      "Placeholder is missing the content property":[ "ჩანაცვლების არეს არ გააჩნია შიგთავსის თვისება" ],
      ...
      "An icon defined in the manifest could not be found in the package.":[ "მანიფესტში განსაზღვრული ხატულა, ნაკრებში ვერ მოიძებნა." ],
      ...
      "A custom content_security_policy needs additional review.":[ "მითითებული content_security_policy საჭიროებს დამატებით განხილვას." ],
      "The \"name\" property must be a string.":[ "თვისება „name“ უნდა წარმოადგენდეს სტრიქონს." ],
      ...
      "The \"version\" property must be a string.":[ "თვისება „version“ უნდა წარმოადგენდეს სტრიქონს." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "იხილეთ http://mzl.la/1kXIADa (MDN მასალები), დამატებითი ინფორმაციისთვის." ],
      "The \"version\" property uses a Firefox-specific format.":[ "თვისება „version“ იყენებს Firefox-ის სახის ფორმატს." ] } } }