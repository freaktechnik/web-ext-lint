module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Dòng" ],
      Column:[ "Cột" ],
      "Invalid nesting of selectors found":[ "Đã tìm thấy lồng ghép không hợp lệ" ],
      "A CSS syntax error was encountered":[ "Đã xảy ra lỗi cú pháp CSS" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListener` đã được gọi với tham số thứ tư là True." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Một tùy chỉnh content_security_policy cần xem xét bổ sung." ],
      "The \"name\" property must be a string.":[ "Thuộc tính \"name\" phải là một chuỗi kí tự." ],
      ...
      "The \"version\" property must be a string.":[ "Thuộc tính \"version\" phải là một chuỗi kí tự." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Xem tại http://mzl.la/1kXIADa (Tài liệu MDN) để biết thêm thông tin." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Thuộc tính \"version\" sử dụng định dạng dành riêng cho Firefox." ] } } }