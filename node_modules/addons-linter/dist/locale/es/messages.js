module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Línea" ],
      Column:[ "Columna" ],
      "Invalid nesting of selectors found":[ "Encontrado anidamiento incorrecto de selectores" ],
      "A CSS syntax error was encountered":[ "Encontrado un error de sintaxis CSS" ],
      ...
      "addEventListener` called with truthy fourth argument.":[ "addEventListenerllamado con un cuarto argumento válido." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Personalizar content_security_policy necesita una revisión adicional." ],
      "The \"name\" property must be a string.":[ "La propiedad \"name\" debe ser un string." ],
      ...
      "The \"version\" property must be a string.":[ "La propiedad \"version\" debe ser un string." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Para más información, consulta http://mzl.la/1kXIADa (documento de MDN)." ],
      "The \"version\" property uses a Firefox-specific format.":[ "La propiedad \"version\" utiliza un formato específico de Firefox." ] } } }