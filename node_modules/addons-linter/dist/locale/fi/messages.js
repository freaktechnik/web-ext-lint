module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      Line:[ "Rivi" ],
      Column:[ "Sarake" ],
      "Invalid nesting of selectors found":[ "Löydettiin virheellinen valitsimien sarja" ],
      "A CSS syntax error was encountered":[ "Havaittiin CSS-kielioppivirhe" ],
      ...
      "The \"name\" property must be a string.":[ "Ominaisuuden \"name\" täytyy olla merkkijono." ],
      ...
      "The \"version\" property must be a string.":[ "Ominaisuuden \"version\" pitää olla merkkijono." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Katso lisätietoja osoitteesta http://mzl.la/1kXIADa (MDN web docs)." ],
      "The \"version\" property uses a Firefox-specific format.":[ "Ominaisuus \"version\" käyttää Firefoxin formaattia." ] } } }