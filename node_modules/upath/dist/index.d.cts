...
export { FormatInputPathObject, ParsedPath } from 'node:path';
...
interface UPath extends PlatformPath {
    VERSION: string;
    sep: '/';
...
export { type PlatformPath, type UPath, VERSION, addExt, basename, changeExt, _default as default, defaultExt, delimiter, dirname, extname, format, isAbsolute, join, joinSafe, matchesGlob, normalize, normalizeSafe, normalizeTrim, parse, posix, relative, removeExt, resolve, sep, toNamespacedPath, toUnix, trimExt, win32 };
