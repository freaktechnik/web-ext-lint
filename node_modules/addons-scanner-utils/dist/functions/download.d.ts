...
export declare const DEFAULT_DOWNLOAD_FILENAME = "input.xpi";
/**
...
export declare class DownloadFileError extends Error {
    status: number;
    extraInfo?: string;
    constructor(message: string, extraInfo?: string, status?: number);
    /**
     * Convert this error to ApiError format.
     */
    toApiError(): import("./api").ApiError;
}
/**
 ...
 */
export declare const downloadFile: ({ downloadURL, tmpDir, filename, env, }: DownloadFileParams) => Promise<string>;
/**
 ...
 */
export declare const downloadFileUpload: ({ downloadURL, allowedOrigin, tmpDir, filename, }: DownloadFileUploadParams) => Promise<string>;
