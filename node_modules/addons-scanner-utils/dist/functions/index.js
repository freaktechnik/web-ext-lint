 ...
 *   body)
 */
const createExpressApp = ({ _console = console, _process = process, apiKeyEnvVarName = 'LAMBDA_API_KEY', } = {}) => (handler) => {
    ...
    app.use((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!allowedMethods
            ...
            next((0, api_1.createApiError)({ message: 'method not allowed', status: 405 }));
            return;
        }
        next();
    }));
    ...
    app.use((req, res, next) => {
        next((0, api_1.createApiError)({ message: 'not found', status: 404 }));
    });
